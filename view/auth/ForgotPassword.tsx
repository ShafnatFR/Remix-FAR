    ...
    <div className="flex w-full min-h-screen bg-[#FDFBF7] font-sans text-stone-900 overflow-hidden">
      <div className="hidden lg:flex lg:w-1/2 relative flex-col justify-between p-12 overflow-hidden border-r border-stone-200">
        ...
        <div className="relative z-10 animate-in slide-in-from-top-8 duration-700">
            <button onClick={() => onNavigate('login')} className="flex items-center gap-2 text-stone-500 hover:text-stone-900 transition-colors group">
                <div className="w-10 h-10 rounded-full bg-stone-100 flex items-center justify-center group-hover:bg-stone-200 transition-all border border-stone-200">
                 ...
                 <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2 animate-in fade-in duration-300" key={method}>
                        <Input 
                            ...
                            className="!bg-stone-50 !border-stone-200 !text-stone-900 placeholder:!text-black focus:!border-orange-500 rounded-xl py-4 pl-12 transition-all hover:!border-stone-300" 
