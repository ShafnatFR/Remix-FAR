                ...
                <div className="w-full max-w-[480px] py-8 lg:py-10 relative z-20">
                    ...
                    {step === 'role' ? (
                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                            {/* Unified Back Button (Mobile & Desktop) */}
                        ...
                        <div className="animate-in fade-in slide-in-from-right-4 duration-500">
                            ...
                            <form onSubmit={handleRegister} className="space-y-5">
                                <Input
                                    ...
                                    className="!bg-stone-50 !border-stone-200 !text-stone-900 !placeholder-stone-400 focus:!border-orange-500 focus:!bg-white rounded-2xl py-3.5 transition-all font-medium"
                                ...
                                <Input
                                    ...
                                    className="!bg-stone-50 !border-stone-200 !text-stone-900 !placeholder-stone-400 focus:!border-orange-500 focus:!bg-white rounded-r-2xl py-3.5 transition-all font-medium"
                                    labelClassName="text-orange-600 font-black text-[10px] uppercase tracking-widest group-focus-within:text-orange-500"
                                    containerClassName="space-y-1"
                                    error={errors.phone}
                                />
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        <Input
                                            ...
                                            className={`!bg-stone-50 !border-stone-200 !text-stone-900 !placeholder-stone-400 focus:!border-orange-500 focus:!bg-white rounded-2xl py-3.5 transition-all font-medium ${errors.password ? '!border-red-500' : ''}`}
                                            labelClassName="text-orange-600 font-black text-[10px] uppercase tracking-widest group-focus-within:text-orange-500"
                                            containerClassName="space-y-1"
                                            rightElement={
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex gap-1 h-1.5">
                                                        {[25, 50, 75, 100].map((step, idx) => (
                                                            <div
                                                                key={idx}
                                                                className={`flex-1 rounded-full transition-all duration-500 ${passwordScore >= step ? strengthLabel.color : 'bg-stone-200'
                                                                    }`}
                                                            />
                                                        ))}
                                                    </div>
                                    ...
                                    <div className="space-y-1">
                                        <Input
                                            ...
                                            className={`!bg-stone-50 !border-stone-200 !text-stone-900 !placeholder-stone-400 focus:!border-orange-500 focus:!bg-white rounded-2xl py-3.5 transition-all font-medium ${errors.confirmPassword ? '!border-red-500' : ''}`}
                                            labelClassName="text-orange-600 font-black text-[10px] uppercase tracking-widest group-focus-within:text-orange-500"
                                            containerClassName="space-y-1"
                                            rightElement={
