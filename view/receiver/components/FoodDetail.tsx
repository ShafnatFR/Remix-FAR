                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex gap-3 w-full">
                        ...
                        <Button
                            ...
                            className={`h-14 flex-1 text-base rounded-2xl shadow-xl font-black tracking-widest uppercase border-0 ${(isOutOfStock || isThisItemActive || hasAddress === false || isLoadingAddress)
