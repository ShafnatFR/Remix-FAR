...
const NotificationSkeleton = () => (
    <div className="p-5 rounded-[2rem] border border-stone-100 dark:border-stone-800 bg-white dark:bg-stone-900 flex gap-4 animate-in fade-in duration-500">
        ...
        <div className="flex-1 space-y-3 py-1">
            ...
            <Skeleton className="h-2 w-1/4 rounded mt-2" />
        </div>
    </div>
);
...
export const NotificationsPage: React.FC<NotificationsPageProps> = ({
    ...
    const notifications = useMemo(() => {
        ...
        return list.sort((a, b) => {
            ...
            // Fallback to numeric IDs if dates are identical/invalid
                                    ...
                                    <div className="flex items-center gap-2 mt-3">
                                        {timeParts ? (
                                            <div className="flex items-center gap-1.5 text-[9px] font-black uppercase tracking-widest text-stone-400">
                                                ...
                                                <span className={`px-1.5 py-0.5 rounded-[4px] text-[8px] font-black border ${timeParts.ampm === 'PM'
