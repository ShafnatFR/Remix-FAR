...
export const ReportsHeader: React.FC<ReportsHeaderProps> = ({ count, layoutMode, setLayoutMode }) => {
    return (
        <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
            <h2 className="text-2xl font-bold text-stone-900 dark:text-white">Laporan Masuk ({count})</h2>
